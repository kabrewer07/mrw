		...
		<form action="/" id="css-builder-custom-css-form" name="css-builder-custom-css-form">
			...
			<div id="genesis-extender-custom-css-editor-wrap-inner" class="bg-box">
				...
				<div id="genesis-extender-floating-save">
					<img id="ajax-save-no-throb" src="<?php echo GENEXT_URL . 'lib/css/images/no-throb.png'; ?>" /><img id="ajax-save-throbber" src="<?php echo GENEXT_URL . 'lib/css/images/throbber.gif'; ?>" /><input type="image" src="<?php echo GENEXT_URL . 'lib/css/images/save-changes-x2.png'; ?>" value="<?php _e( 'Save Changes', 'extender' ); ?>" class="genesis-extender-save-button" name="Submit" alt="Save Changes" />
				</div>
				
				<div id="custom-css-builder-nav-css-box">
					<textarea wrap="off" id="genesis-extender-custom-css" name="extender[custom_css]"><?php echo genesis_extender_get_custom_css( 'custom_css' ); ?></textarea>
				</div>
