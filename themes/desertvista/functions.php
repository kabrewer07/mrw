...
add_theme_support( 'genesis-style-selector', array( 'desertvista-silver' => 'Silver', 'desertvista-green' => 'Green', 'desertvista-red' => 'Red', 'desertvista-brown' => 'Brown', 'desertvista-blue' => 'Blue', 'desertvista-black' => 'Black' ) );

add_action( 'genesis_meta', 'desertvista_add_viewport_meta_tag' );
function desertvista_add_viewport_meta_tag() {
    echo '<meta name="viewport" content="width=device-width, initial-scale=1.0"/>';
}



add_filter('body_class','desertvista_color_body_class');
add_filter('body_class','desertvista_background_body_class');

function desertvista_color_body_class($classes) {
	$color = "blue";
	if(isset($_GET['color'])) $color = $_GET['color'];
	$classes[] = 'desertvista-'.$color;
	return $classes;
}

function desertvista_background_body_class($classes) {
	$background = "tempe";
	if(isset($_GET['background'])) $background = $_GET['background'];
	$classes[] = 'desertvista-'.$background;
	return $classes;
}


/** Child theme (do not remove) */
define( 'CHILD_THEME_NAME', 'desertvista Theme' );
define( 'CHILD_THEME_URL', 'http://www.studiopress.com/themes/desertvista' );
...
add_theme_support( 'genesis-custom-header', array( 'width' => 1400, 'height' => 600, 'textcolor' => '333' ) );

/** Reposition the secondary navigation */
remove_action( 'genesis_after_header', 'genesis_do_subnav' );
add_action( 'genesis_before_header', 'genesis_do_subnav' );

add_action('genesis_before_header','desertvista_add_demo_nav');
function desertvista_add_demo_nav() {
...
add_action( 'genesis_after_header', 'desertvista_top_search' );
/**
 * Add top search widget area on Genesis after header hook
 *
 */
function desertvista_top_search() {
...
add_action( 'genesis_after', 'desertvista_disclaimer' );
/**
 * Add disclaimer widget area on Genesis after hook
 *
 */
function desertvista_disclaimer() {
...
add_filter( 'desertvista_property_details', 'desertvista_property_details_filter' );
/**
 * Filter the property details array.
 *
 */
function desertvista_property_details_filter( $details ) {
...
add_filter( 'desertvista_featured_listings_widget_loop', 'desertvista_featured_listings_widget_loop_filter' );
/**
 * Filter the loop output of the desertvista Featured Listings Widget.
 *
 */
function desertvista_featured_listings_widget_loop_filter( $loop ) {
...
genesis_register_sidebar( array(
	'id'			=> 'top-search',
	'name'			=> __( 'Top Search', 'desertvista' ),
	'description'	=> __( 'This is the top search section.', 'desertvista' ),
) );
genesis_register_sidebar( array(
	'id'			=> 'slider',
	'name'			=> __( 'Slider', 'desertvista' ),
	'description'	=> __( 'This is the slider section.', 'desertvista' ),
) );
genesis_register_sidebar( array(
	'id'			=> 'property-search',
	'name'			=> __( 'Property Search', 'desertvista' ),
	'description'	=> __( 'This is the property search section.', 'desertvista' ),
) );
genesis_register_sidebar( array(
	'id'			=> 'welcome',
	'name'			=> __( 'Welcome', 'desertvista' ),
	'description'	=> __( 'This is the welcome section.', 'desertvista' ),
) );
genesis_register_sidebar( array(
	'id'			=> 'properties',
	'name'			=> __( 'Properties', 'desertvista' ),
	'description'	=> __( 'This is the properties section.', 'desertvista' ),
) );
genesis_register_sidebar( array(
	'id'			=> 'communities',
	'name'			=> __( 'Communities', 'desertvista' ),
	'description'	=> __( 'This is the communities section.', 'desertvista' ),
) );
genesis_register_sidebar( array(
	'id'			=> 'featured-bottom-left',
	'name'			=> __( 'Featured Bottom Left', 'desertvista' ),
	'description'	=> __( 'This is the featured bottom left section.', 'desertvista' ),
) );
genesis_register_sidebar( array(
	'id'			=> 'featured-bottom-right',
	'name'			=> __( 'Featured Bottom Right', 'desertvista' ),
	'description'	=> __( 'This is the featured bottom right section.', 'desertvista' ),
) );
genesis_register_sidebar( array(
	'id'			=> 'disclaimer',
	'name'			=> __( 'Disclaimer', 'desertvista' ),
	'description'	=> __( 'This is the disclaimer section.', 'desertvista' ),
) );
