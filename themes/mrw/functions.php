...
genesis_register_sidebar( array(
	'id'			=> 'welcome',
	'name'			=> __( 'Welcome', 'signature' ),
	'description'	=> __( 'This is the welcome section.', 'signature' ),
) );
genesis_register_sidebar( array(
	'id'			=> 'properties',
...
genesis_register_sidebar( array(
	'id'			=> 'communities',
	'name'			=> __( 'Communities', 'signature' ),
	'description'	=> __( 'This is the communities section.', 'signature' ),
) );
genesis_register_sidebar( array(
