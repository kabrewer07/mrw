...
.executive-custome a,
.executive-custome a:visited {
	color: #3C5421;
}

.executive-custome .menu-primary a,
.executive-custome .menu-secondary a,
.executive-custome #header .menu a {
	color: #666;
}

.executive-custome a.button,
.executive-custome .menu-primary li a:active,
.executive-custome .menu-primary .current-menu-item a,
.executive-custome .menu-secondary li a:active,
.executive-custome .menu-secondary .current-menu-item a,
.executive-custome #header .menu li a:active,
.executive-custome #header .menu .current-menu-item a {
	color: #fff;
}

.executive-custome input[type="button"],
.executive-custome input[type="submit"],
.executive-custome a.button,
.executive-custome .menu-primary li a:active,
.executive-custome .menu-primary .current-menu-item a,
.executive-custome .menu-secondary li a:active,
.executive-custome .menu-secondary .current-menu-item a,
.executive-custome .navigation li a,
.executive-custome .navigation li.disabled,
.executive-custome .navigation li a:hover,
.executive-custome .navigation li.active a,
.executive-custome .post-info .comments,
.executive-custome #header .menu li a:active,
.executive-custome #header .menu .current-menu-item a {
	background-color: #3C5421;
}

.executive-custome input:hover[type="button"],
.executive-custome input:hover[type="submit"],
.executive-custome a:hover.button,
.executive-custome .navigation li a:hover,
.executive-custome .navigation li.active a  {
	background-color: #66d970;
}

.executive-custome h2 a,
.executive-custome h2 a:visited {
	color: #222;
}

.executive-custome.executive-home .featuredpost h2 a {
	color: #444;
}

.executive-custome h2 a:hover,
.executive-custome.executive-home h2 a:hover,
.executive-custome.executive-home .executive-home .featuredpost h2 a:hover {
	color: #3C5421;
}

.executive-custome .commentmetadata a {
	color: #bbb;
}
