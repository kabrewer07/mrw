	...
	<div class="wrap">
		...
		<div id="dynamik-admin-wrap">
			...
			<form action="/" id="custom-options-form" name="custom-options-form">
				...
				<div id="dynamik-custom-options-nav">
					<ul>
			...
			<div style="display:none; position:inherit; height:25px; width:520px; margin:-11px 0 0 135px; float:left;" id="show-options-reset-box" class="dynamik-custom-fonts-box">
				<form style="width:520px; float:left;" id="dynamik-reset-custom-options" method="post">
					...
					<input style="background:#D54E21; width:160px !important; color:#FFFFFF !important; text-shadow: 0 0 0 #fff;" type="submit" value="<?php _e( 'Reset Custom Options', 'dynamik' ); ?>" class="dynamik-reset button" name="Submit" onClick='return confirm("<?php _e( 'Are you sure your want to reset your Dynamik Custom Options?', 'dynamik' ); ?>")'/><input type="hidden" name="action" value="reset" />
				</form>
			</div>
		</div>
	</div> <!-- Close Wrap -->
