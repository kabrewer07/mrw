	...
	<div class="dynamik-optionbox-inner-1col">
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-nav2-font-size" name="dynamik[nav2_font_size]" value="<?php dynamik_design_options_defaults( true, 'nav2_font_size' ); ?>" style="width:40px;" />
				<select class="dynamik-universal-px-em-child" id="dynamik-nav2-px-em" name="dynamik[nav2_px_em]" size="1" style="width:50px;">
					<option value="px"<?php echo ( dynamik_get_design( 'nav2_px_em' ) == 'px' ) ? ' selected="selected"' : ''; ?>>px</option>
					<option value="em"<?php echo ( dynamik_get_design( 'nav2_px_em' ) == 'em' ) ? ' selected="selected"' : ''; ?>>em</option>
				</select>
				...
				<textarea class="dynamik-universal-font-css-child" id="dynamik-nav2-font-css" name="dynamik[nav2_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'nav2_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<?php _e( 'Thickness', 'dynamik' ); ?> <input type="text" id="dynamik-nav2-border-thickness" name="dynamik[nav2_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'nav2_border_thickness' ); ?>" style="width:35px;" /><?php _e( 'px |', 'dynamik' ); ?>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<?php _e( 'Top', 'dynamik' ); ?> <input type="text" id="dynamik-nav2-page-top-border-thickness" name="dynamik[nav2_page_top_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'nav2_page_top_border_thickness' ); ?>" style="width:35px;" /><?php _e( 'px', 'dynamik' ); ?>
				<?php _e( '| Btm', 'dynamik' ); ?> <input type="text" id="dynamik-nav2-page-bottom-border-thickness" name="dynamik[nav2_page_bottom_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'nav2_page_bottom_border_thickness' ); ?>" style="width:35px;" /><?php _e( 'px', 'dynamik' ); ?>
				<?php _e( '| Lft', 'dynamik' ); ?> <input type="text" id="dynamik-nav2-page-left-border-thickness" name="dynamik[nav2_page_left_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'nav2_page_left_border_thickness' ); ?>" style="width:35px;" /><?php _e( 'px', 'dynamik' ); ?>
				<?php _e( '| Rt', 'dynamik' ); ?> <input type="text" id="dynamik-nav2-page-right-border-thickness" name="dynamik[nav2_page_right_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'nav2_page_right_border_thickness' ); ?>" style="width:35px;" /><?php _e( 'px', 'dynamik' ); ?>
		...
		<div class="dynamik-design-option">
			<p>
				...
				<input type="text" id="dynamik-nav2-wrap-top-margin" name="dynamik[nav2_wrap_top_margin]" value="<?php dynamik_design_options_defaults( true, 'nav2_wrap_top_margin' ); ?>" style="width:35px;" /><?php _e( 'px |', 'dynamik' ); ?>
				<?php _e( 'Bottom Margin', 'dynamik' ); ?>
				<input type="text" id="dynamik-nav2-wrap-bottom-margin" name="dynamik[nav2_wrap_bottom_margin]" value="<?php dynamik_design_options_defaults( true, 'nav2_wrap_bottom_margin' ); ?>" style="width:35px;" /><?php _e( 'px', 'dynamik' ); ?>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				<?php _e( 'Margin: Left', 'dynamik' ); ?> <input type="text" id="dynamik-nav2-page-left-margin" name="dynamik[nav2_page_left_margin]" value="<?php dynamik_design_options_defaults( true, 'nav2_page_left_margin' ); ?>" style="width:30px;" /><?php _e( 'px', 'dynamik' ); ?>
				<?php _e( 'Right', 'dynamik' ); ?> <input type="text" id="dynamik-nav2-page-right-margin" name="dynamik[nav2_page_right_margin]" value="<?php dynamik_design_options_defaults( true, 'nav2_page_right_margin' ); ?>" style="width:30px;" /><?php _e( 'px', 'dynamik' ); ?>
				<?php _e( '| Padding: Top/Btm', 'dynamik' ); ?> <input type="text" id="dynamik-nav2-page-tb-padding" name="dynamik[nav2_page_tb_padding]" value="<?php dynamik_design_options_defaults( true, 'nav2_page_tb_padding' ); ?>" style="width:30px;" /><?php _e( 'px', 'dynamik' ); ?>
				<?php _e( 'Lft/Rt', 'dynamik' ); ?> <input type="text" id="dynamik-nav2-page-lr-padding" name="dynamik[nav2_page_lr_padding]" value="<?php dynamik_design_options_defaults( true, 'nav2_page_lr_padding' ); ?>" style="width:30px;" /><?php _e( 'px', 'dynamik' ); ?>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<?php _e( 'Width', 'dynamik' ); ?> <input type="text" id="dynamik-nav2-submenu-width" name="dynamik[nav2_submenu_width]" value="<?php dynamik_design_options_defaults( true, 'nav2_submenu_width' ); ?>" style="width:40px;" /><?php _e( 'px', 'dynamik' ); ?>
				<span class="dynamik-design-standard-hide">
				<?php _e( 'Padding: Top/Btm', 'dynamik' ); ?> <input type="text" id="dynamik-nav2-submenu-tb-padding" name="dynamik[nav2_submenu_tb_padding]" value="<?php dynamik_design_options_defaults( true, 'nav2_submenu_tb_padding' ); ?>" style="width:30px;" /><?php _e( 'px', 'dynamik' ); ?>
				<?php _e( 'Lft/Rt', 'dynamik' ); ?> <input type="text" id="dynamik-nav2-submenu-lr-padding" name="dynamik[nav2_submenu_lr_padding]" value="<?php dynamik_design_options_defaults( true, 'nav2_submenu_lr_padding' ); ?>" style="width:30px;" /><?php _e( 'px', 'dynamik' ); ?>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				<?php _e( 'Type', 'dynamik' ); ?> <select id="dynamik-nav2-sub-indicator-type" class="dynamik-nav-sub-indicator-type" name="dynamik[nav2_sub_indicator_type]" size="1" style="width:65px;">
				...
				<input type="text" id="dynamik-nav2-sub-indicator-width" name="dynamik[nav2_sub_indicator_width]" value="<?php dynamik_design_options_defaults( true, 'nav2_sub_indicator_width' ); ?>" style="width:30px;" /><?php _e( 'px |', 'dynamik' ); ?>
				<?php _e( 'Height', 'dynamik' ); ?>
				<input type="text" id="dynamik-nav2-sub-indicator-height" name="dynamik[nav2_sub_indicator_height]" value="<?php dynamik_design_options_defaults( true, 'nav2_sub_indicator_height' ); ?>" style="width:30px;" /><?php _e( 'px |', 'dynamik' ); ?>
				<?php _e( 'Top', 'dynamik' ); ?>
				<input type="text" id="dynamik-nav2-sub-indicator-top" name="dynamik[nav2_sub_indicator_top]" value="<?php dynamik_design_options_defaults( true, 'nav2_sub_indicator_top' ); ?>" style="width:30px;" /><?php _e( 'px |', 'dynamik' ); ?>
				<?php _e( 'Right', 'dynamik' ); ?>
				<input type="text" id="dynamik-nav2-sub-indicator-right" name="dynamik[nav2_sub_indicator_right]" value="<?php dynamik_design_options_defaults( true, 'nav2_sub_indicator_right' ); ?>" style="width:30px;" /><?php _e( 'px', 'dynamik' ); ?>
				</span>
			</p>
		</div>
