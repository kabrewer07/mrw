...
<div style="display:none;" id="dynamik-custom-css-builder" class="dynamik-optionbox-outer-1col">
	<div class="dynamik-optionbox-inner-1col">
		<h3 style="cursor:pointer; -moz-border-radius: 3px 3px 0px 0px; -webkit-border-radius: 3px 3px 0px 0px; border-radius: 3px 3px 0px 0px;"><?php _e( 'Custom CSS Builder', 'dynamik' ); ?> <span id="custom-css-builder-tooltip" class="tooltip-mark tooltip-bottom-center">[?]</span></h3>
		...
		<div class="tooltip tooltip-600">
			...
			<p>
				...
				<center><img src="<?php echo CHILD_URL ?>/lib/css/images/tooltips/tooltip-custom-buttons.png"/></center>
			</p>
		</div>
			...
			<div id="dynamik-custom-css-builder-wrap-inner" class="bg-box">
				...
				<div id="custom-css-builder-nav-fonts-box" class="dynamik-all-css-builder dynamik-options-display">
					<p style="float:left;">
						...
						<input type="text" id="font_size" name="font_size" value="12" style="width:35px;" /><?php _e( 'px', 'dynamik' ); ?> (<a href="http://pxtoem.com/" target="_blank">convert px to em</a>)<br />
