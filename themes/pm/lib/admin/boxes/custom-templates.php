...
<div id="dynamik-custom-options-nav-templates-box" class="dynamik-optionbox-outer-1col dynamik-all-options">
	<div class="dynamik-optionbox-inner-1col">
		<h3><?php _e( 'Custom Templates', 'dynamik' ); ?><span style="margin:-3px 10px 0 -75px !important; font-weight:normal; float:right;" class="button add-template"><?php _e( 'Add', 'dynamik' ); ?></span> <span id="custom-templates-tooltip" class="tooltip-mark tooltip-bottom-center">[?]</span></h3>
...
?>				<div id="template-<?php echo $template_counter; ?>" class="dynamik-all-templates">
					<div class="dynamik-custom-template-option">
						<p class="bg-box-design">
							<?php _e( 'File Name', 'dynamik' ); ?> <input type="text" id="custom-template-id-<?php echo $template_counter; ?>" name="custom_template_ids[<?php echo $template_counter; ?>]" value="<?php echo $custom_template['template_file_name']; ?>" style="width:190px;" class="forbid-template-chars forbid-caps forbid-names" /><?php _e( '.php | Template Name', 'dynamik' ); ?> <input type="text" id="custom-template-name-<?php echo $template_counter; ?>" name="custom_template_names[<?php echo $template_counter; ?>]" value="<?php echo $custom_template['template_name']; ?>" style="width:190px;" /> <?php _e( 'Template Type', 'dynamik' ); ?> <select id="custom-template-type-<?php echo $template_counter; ?>" name="custom_template_types[<?php echo $template_counter; ?>]" ><option value="page_template"<?php echo ( $custom_template['template_type'] == 'page_template' ) ? ' selected="selected"' : ''; ?>><?php _e( 'Page Template', 'dynamik' ); ?></option><option value="wp_template"<?php echo ( $custom_template['template_type'] == 'wp_template' ) ? ' selected="selected"' : ''; ?>><?php _e( 'WordPress Template', 'dynamik' ); ?></option></select>
						</p>
						...
						<p style="padding-top:3px;">
							<textarea class="resizable dynamik-tabby-textarea" id="custom-template-textarea-<?php echo $template_counter; ?>" name="custom_template_textarea[<?php echo $template_counter; ?>]" style="width:778px;height:100px;text-align:left;margin-top:4px !important;"><?php echo $custom_template['template_textarea']; ?></textarea>
						</p>
					</div>
				</div>
<?php		}
	...
	?>		<div id="template-1" class="dynamik-all-templates">
				<div class="dynamik-custom-template-option">
					<p class="bg-box-design">
						<?php _e( 'File Name', 'dynamik' ); ?> <input type="text" id="custom-template-id-1" name="custom_template_ids[1]" value="" style="width:190px;" class="forbid-template-chars forbid-caps forbid-names" /><?php _e( '.php | Template Name', 'dynamik' ); ?> <input type="text" id="custom-template-name-1" name="custom_template_names[1]" value="" style="width:190px;" /> <?php _e( 'Template Type', 'dynamik' ); ?> <select id="custom-template-type-1" name="custom_template_types[1]" ><option value="page_template"><?php _e( 'Page Template', 'dynamik' ); ?></option><option value="wp_template"><?php _e( 'WordPress Template', 'dynamik' ); ?></option></select>
					<p style="float:right;">
					...
					<p style="padding-top:3px;">
						<textarea class="resizable dynamik-tabby-textarea" id="custom-template-textarea-1" name="custom_template_textarea[1]" style="width:778px;height:100px;text-align:left;margin-top:4px !important;"></textarea>
					</p>
				</div>
			</div>
<?php	}
