...
?>
	...
	<div class="dynamik-optionbox-inner-1col">
		<h3 style="-moz-border-radius:6px 6px 0 0; -webkit-border-radius:6px 6px 0 0; border-radius:6px 6px 0 0;"><?php _e( 'Dynamik Settings/Custom Import/Export', 'dynamik' ); ?></h3>
	...
	<?php if( defined( 'GENEXT_VERSION' ) ) { ?>
		...
		<div class="dynamik-optionbox-inner-1col" style="margin-top:-10px;">
			<h3 style="-moz-border-radius:6px 6px 0 0; -webkit-border-radius:6px 6px 0 0; border-radius:6px 6px 0 0;"><?php _e( 'Dynamik Theme/Genesis Extender Plugin Cloning', 'dynamik' ); ?></h3>
