...
function dynamik_build_design_styles( $child = 'no' )
{
	...
	****************************************/
	...
	// Vertical Menu Toggle Button styles
	...
	****************************************/
	...
	$body_font_size = dynamik_get_design( 'body_font_size' );
	...
	$title_font_size = dynamik_get_design( 'title_font_size' ) . dynamik_get_design( 'title_px_em' );
	...
	$tagline_font_size = dynamik_get_design( 'tagline_font_size' ) . dynamik_get_design( 'tagline_px_em' );
	$tagline_font_color = dynamik_get_design( 'tagline_font_color' );
	
	// Navb fonts
	$nav1_font_type = $dynamik_font_type['nav1'];
	$nav1_font_size = dynamik_get_design( 'nav1_font_size' ) . dynamik_get_design( 'nav1_px_em' );
	if( dynamik_get_design( 'nav1_px_em' ) == 'em' )
	{
		$nav1_font_size_px = round( dynamik_get_design( 'nav1_font_size' ) * $body_font_size, 0 );
	}
	else
	{
	...
	$nav1_extras_font_size = dynamik_get_design( 'nav1_extras_font_size' ) . dynamik_get_design( 'nav1_extras_px_em' );
	...
	$nav2_font_size = dynamik_get_design( 'nav2_font_size' ) . dynamik_get_design( 'nav2_px_em' );
	if( dynamik_get_design( 'nav2_px_em' ) == 'em' )
	{
		$nav2_font_size_px = round( dynamik_get_design( 'nav2_font_size' ) * $body_font_size, 0 );
	}
	else
	{
	...
	$nav3_font_size = dynamik_get_design( 'nav3_font_size' ) . dynamik_get_design( 'nav3_px_em' );
	if( dynamik_get_design( 'nav3_px_em' ) == 'em' )
	{
		$nav3_font_size_px = round( dynamik_get_design( 'nav3_font_size' ) * $body_font_size, 0 );
	}
	else
	{
	...
	$content_heading_h1_font_size = dynamik_get_design( 'content_heading_h1_font_size' ) . dynamik_get_design( 'h1_px_em' );
	$content_heading_h2_font_size = dynamik_get_design( 'content_heading_h2_font_size' ) . dynamik_get_design( 'h2_px_em' );
	$content_heading_h3_font_size = dynamik_get_design( 'content_heading_h3_font_size' ) . dynamik_get_design( 'h3_px_em' );
	$content_heading_h4_font_size = dynamik_get_design( 'content_heading_h4_font_size' ) . dynamik_get_design( 'h4_px_em' );
	$content_heading_h5_font_size = dynamik_get_design( 'content_heading_h5_font_size' ) . dynamik_get_design( 'h5_px_em' );
	$content_heading_h6_font_size = dynamik_get_design( 'content_heading_h6_font_size' ) . dynamik_get_design( 'h6_px_em' );
	...
	$content_p_font_size = dynamik_get_design( 'content_p_font_size' ) . dynamik_get_design( 'content_p_px_em' );
	...
	$content_byline_font_size = dynamik_get_design( 'content_byline_font_size' ) . dynamik_get_design( 'content_byline_px_em' );
	...
	$sb_heading_font_size = dynamik_get_design( 'sb_heading_font_size' ) . dynamik_get_design( 'sb_heading_px_em' );
	$sb_heading_font_color = dynamik_get_design( 'sb_heading_font_color' );
	
	$sb_content_font_type = $dynamik_font_type['sb_content'];
	$sb_content_font_size = dynamik_get_design( 'sb_content_font_size' ) . dynamik_get_design( 'sb_content_px_em' );
	...
	$breadcrumbs_font_size = dynamik_get_design( 'breadcrumbs_font_size' ) . dynamik_get_design( 'breadcrumbs_px_em' );
	...
	$taxonomy_box_heading_font_size = dynamik_get_design( 'taxonomy_box_heading_font_size' ) . dynamik_get_design( 'taxonomy_box_heading_px_em' );
	...
	$taxonomy_box_content_font_size = dynamik_get_design( 'taxonomy_box_content_font_size' ) . dynamik_get_design( 'taxonomy_box_content_px_em' );
	...
	$author_box_title_font_size = dynamik_get_design( 'author_box_title_font_size' ) . dynamik_get_design( 'author_box_title_px_em' );
	...
	$author_box_font_size = dynamik_get_design( 'author_box_font_size' ) . dynamik_get_design( 'author_box_px_em' );
	...
	$post_nav_font_size = dynamik_get_design( 'post_nav_font_size' ) . dynamik_get_design( 'post_nav_px_em' );
	...
	$blockquote_font_size = dynamik_get_design( 'blockquote_font_size' ) . dynamik_get_design( 'blockquote_px_em' );
	...
	$caption_font_size = dynamik_get_design( 'caption_font_size' ) . dynamik_get_design( 'caption_px_em' );
	$caption_font_color = dynamik_get_design( 'caption_font_color' );
	
	// Post-Meta fonts
	$post_meta_font_type = $dynamik_font_type['post_meta'];
	$post_meta_font_size = dynamik_get_design( 'post_meta_font_size' ) . dynamik_get_design( 'post_meta_px_em' );
	...
	$ez_widget_home_title_font_size = dynamik_get_design( 'ez_widget_home_title_font_size' ) . dynamik_get_design( 'ez_widget_home_title_px_em' );
	...
	$ez_widget_home_content_font_size = dynamik_get_design( 'ez_widget_home_content_font_size' ) . dynamik_get_design( 'ez_widget_home_content_px_em' );
	...
	$ez_widget_feature_title_font_size = dynamik_get_design( 'ez_widget_feature_title_font_size' ) . dynamik_get_design( 'ez_widget_feature_title_px_em' );
	...
	$ez_widget_feature_content_font_size = dynamik_get_design( 'ez_widget_feature_content_font_size' ) . dynamik_get_design( 'ez_widget_feature_content_px_em' );
	...
	$ez_widget_footer_title_font_size = dynamik_get_design( 'ez_widget_footer_title_font_size' ) . dynamik_get_design( 'ez_widget_footer_title_px_em' );
	...
	$ez_widget_footer_content_font_size = dynamik_get_design( 'ez_widget_footer_content_font_size' ) . dynamik_get_design( 'ez_widget_footer_content_px_em' );
	...
	$featured_widget_heading_font_size = dynamik_get_design( 'featured_widget_heading_font_size' ) . dynamik_get_design( 'featured_widget_heading_px_em' );
	...
	$featured_widget_p_font_size = dynamik_get_design( 'featured_widget_p_font_size' ) . dynamik_get_design( 'featured_widget_p_px_em' );
	...
	$featured_widget_byline_font_size = dynamik_get_design( 'featured_widget_byline_font_size' ) . dynamik_get_design( 'featured_widget_byline_px_em' );
	...
	$dynamik_widget_title_font_size = dynamik_get_design( 'dynamik_widget_title_font_size' ) . dynamik_get_design( 'dynamik_widget_title_px_em' );
	...
	$dynamik_widget_content_font_size = dynamik_get_design( 'dynamik_widget_content_font_size' ) . dynamik_get_design( 'dynamik_widget_content_px_em' );
	...
	$comment_heading_font_size = dynamik_get_design( 'comment_heading_font_size' ) . dynamik_get_design( 'comment_heading_px_em' );
	...
	$comment_author_font_size = dynamik_get_design( 'comment_author_font_size' ) . dynamik_get_design( 'comment_author_px_em' );
	...
	$comment_meta_font_size = dynamik_get_design( 'comment_meta_font_size' ) . dynamik_get_design( 'comment_meta_px_em' );
	...
	$comment_body_font_size = dynamik_get_design( 'comment_body_font_size' ) . dynamik_get_design( 'comment_body_px_em' );
	...
	$comment_form_font_size = dynamik_get_design( 'comment_form_font_size' ) . dynamik_get_design( 'comment_form_px_em' );
	...
	$comment_submit_font_size = dynamik_get_design( 'comment_submit_font_size' ) . dynamik_get_design( 'comment_submit_px_em' );
	...
	$comment_form_allowed_tags_font_size = dynamik_get_design( 'comment_form_allowed_tags_font_size' ) . dynamik_get_design( 'comment_form_allowed_tags_px_em' );
	...
	$footer_font_size = dynamik_get_design( 'footer_font_size' ) . dynamik_get_design( 'footer_px_em' );
	...
	$search_form_font_size = dynamik_get_design( 'search_form_font_size' ) . dynamik_get_design( 'search_form_px_em' );
	$search_form_font_color = dynamik_get_design( 'search_form_font_color' );
	
	$search_button_font_type = $dynamik_font_type['search_button'];
	$search_button_font_size = dynamik_get_design( 'search_button_font_size' ) . dynamik_get_design( 'search_button_px_em' );
...
.menu-secondary.sf-arrows li li .sf-with-ul:after {
	...
	$nav3_sf_right_padding = $nav3_page_lr_padding + 10;
...
.full-width-content ' . dynamik_html_markup( 'site_container' ) . ' {
	...
	if( dynamik_get_responsive( 'header_media_query_default' ) == 'default' )
	{
		...
		$header_mq_first .= '.header-image ' . dynamik_html_markup( 'site_header' ) . ' .wrap ' . dynamik_html_markup( 'title_area' ) . ' { margin: 0 auto; float: none; }' . "\n";
	}
	else
	{
		$header_mq_first = '';
	...
	elseif( dynamik_get_responsive( 'navbar_media_query_default' ) == 'vertical' || dynamik_get_responsive( 'navbar_media_query_default' ) == 'vertical_toggle' )
	{
		...
		if( dynamik_get_responsive( 'navbar_media_query_default' ) == 'vertical_toggle' ) {
			...
			$navbar_mq_third .= '.mobile-primary-toggle, .mobile-secondary-toggle { display: none; }' . "\n";
		} else {
			$navbar_mq_third = '';
		}
		...
		$navbar_mq_sixth .= '.menu-primary, .menu-secondary, ' . dynamik_html_markup( 'site_header' ) . ' .menu, .menu-primary li, .menu-secondary li, ' . dynamik_html_markup( 'site_header' ) . ' .genesis-nav-menu li, .menu-primary li ul, .menu-secondary li ul, ' . dynamik_html_markup( 'site_header' ) . ' .genesis-nav-menu li ul { width: 100%; }' . "\n";
		...
		if( dynamik_get_responsive( 'navbar_media_query_default' ) == 'vertical_toggle' ) {
			...
			$navbar_mq_sixth .= '.mobile-primary-toggle, .mobile-secondary-toggle { display: block; }' . "\n";
		}
	}
	elseif( dynamik_get_responsive( 'navbar_media_query_default' ) == 'tablet_dropdown' )
	{
		...
		$navbar_mq_first .= '#dropdown-nav-wrap, #dropdown-subnav-wrap { padding: 0 ' . $inner_lr_padding . 'px 0 ' . $inner_lr_padding . 'px; display: block; }' . "\n";
		$navbar_mq_third = '';
		$navbar_mq_sixth = '';
	}
	elseif( dynamik_get_responsive( 'navbar_media_query_default' ) == 'mobile_dropdown' )
	{
		...
		$navbar_mq_third = '';
		$navbar_mq_sixth = dynamik_html_markup( 'nav_primary' ) . ', ' . dynamik_html_markup( 'nav_secondary' ) . ' { display: none; }' . "\n";
		$navbar_mq_sixth .= '#dropdown-nav-wrap, #dropdown-subnav-wrap { padding: 0 ' . $inner_lr_padding . 'px 0 ' . $inner_lr_padding . 'px; display: block; }' . "\n";
	}
	else
	{
		$navbar_mq_first = '';
	...
	{
		$ez_mq_first = '#ez-home-container-wrap, #ez-home-sidebar-wrap { width: 100%; }' . "\n";
		...
		$ez_mq_first .= '.three-sixths, .two-fifths, .two-fourths, .two-sixths, .two-thirds { width: 100%; padding: 0 0 ' . $content_paragraph_margin_bottom . 'px; }' . "\n";
	...
	elseif( dynamik_get_responsive( 'ez_media_query_default' ) == 'delayed' )
	{
		...
		$ez_mq_fourth .= '.three-sixths, .two-fifths, .two-fourths, .two-sixths, .two-thirds { width: 100%; padding: 0 0 ' . $content_paragraph_margin_bottom . 'px; }' . "\n";
...
' . dynamik_html_markup( 'comment_author_link' ) . ' a,
.comment-author .says {
...
.comment-content p,
' . dynamik_html_markup( 'comment_reply' ) . ',
#respond p {
...
' . dynamik_html_markup( 'comment_reply' ) . ' a,
' . dynamik_html_markup( 'comment_reply' ) . ' a:visited,
...
' . dynamik_html_markup( 'comment_reply' ) . ' a:hover,
...
@media only screen and (max-width: ' . $media_wrap_width . 'px) {
...
@media only screen and (min-width: 768px) and (max-width: ' . $media_wrap_width . 'px) {
' . $media_query_large_content . '
}

@media only screen and (min-width: 480px) and (max-width: ' . $media_wrap_width . 'px) {
' . $navbar_mq_third . $media_query_medium_large_content . '
}

@media only screen and (max-width: 767px) {
' . $ez_mq_fourth . $media_query_medium_cascading_content . '
}
