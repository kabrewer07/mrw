...
add_action( 'genesis_loop', 'inspiration_listing_archive_loop' );
/**
 * Custom loop for listing archive page
 */
function inspiration_listing_archive_loop() {
	...
	if ( have_posts() ) : while ( have_posts() ) : the_post();
		...
		$loop .= sprintf( '<a href="%s" class="more-link">%s</a>', get_permalink(), __( 'View Listing', 'inspiration' ) );
