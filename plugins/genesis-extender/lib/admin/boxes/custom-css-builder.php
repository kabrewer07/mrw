...
<div style="display:none;" id="genesis-extender-custom-css-builder" class="genesis-extender-optionbox-outer-1col">
	<div class="genesis-extender-optionbox-inner-1col">
		<h3 style="cursor:pointer; -moz-border-radius: 3px 3px 0px 0px; -webkit-border-radius: 3px 3px 0px 0px; border-radius: 3px 3px 0px 0px;"><?php _e( 'Custom CSS Builder', 'extender' ); ?> <span id="custom-css-builder-tooltip" class="tooltip-mark tooltip-bottom-center">[?]</span></h3>
			...
			<div id="genesis-extender-custom-css-builder-wrap-inner" class="bg-box">
				...
				<div id="custom-css-builder-nav-fonts-box" class="genesis-extender-all-css-builder genesis-extender-options-display">
					<p style="float:left;">
						...
						<input type="text" id="font_size" name="font_size" value="12" style="width:35px;" /><?php _e( 'px', 'extender' ); ?> (<a href="http://pxtoem.com/" target="_blank">convert px to em</a>)<br />
