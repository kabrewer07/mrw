...
jQuery(document).ready(function($){
	...
	$('.add-template').click(function () { 
		template_counter += 1;
		$('#genesis-extender-templates-wrap').prepend('<div id="template-' + template_counter + '"><div class="genesis-extender-custom-template-option"><p class="bg-box-design">' + e_file_name + ' <input type="text" id="custom-template-id-' + template_counter + '" name="custom_template_ids[' + template_counter + ']" value="" style="width:190px;" class="forbid-template-chars forbid-caps forbid-names" />.php | ' + e_template_name + ' <input type="text" id="custom-template-name-' + template_counter + '" name="custom_template_names[' + template_counter + ']" value="" style="width:190px;" />  ' + e_template_type + ' <select id="custom-template-type-' + template_counter + '" name="custom_template_types[' + template_counter + ']" ><option value="page_template">' + e_page_template + '</option><option value="wp_template">' + e_wp_template + '</option></select></p><p style="float:right;"><span id="' + template_counter + '" class="button delete-template">' + e_delete + '</span><span class="do-shortcode button" style="margin-right:192px !important;">' + e_do_shortcode + '</span></p><p style="padding-top:3px;"><textarea class="resizable genesis-extender-tabby-textarea genesis-extender-tabby-textarea-temp" id="custom-template-textarea-' + template_counter + '" name="custom_template_textarea[' + template_counter + ']" style="width:778px;height:100px;text-align:left;margin-top:4px !important;"></textarea></p></div></div>');
	});
