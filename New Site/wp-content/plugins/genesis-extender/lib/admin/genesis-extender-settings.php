	...
	<div class="wrap">
		...
		<div id="genesis-extender-admin-wrap">
			...
			<form action="/" id="plugin-settings-form" name="plugin-settings-form">
				...
				<div id="genesis-extender-settings-nav">
					<ul>
			...
			<div style="display:none; position:inherit; height:25px; width:520px; margin:-11px 0 0 135px; float:left;" id="show-options-reset-box" class="genesis-extender-custom-fonts-box">
				<form style="width:520px; float:left;" id="genesis-extender-reset-plugin-settings" method="post">
					...
					<input style="background:#D54E21; width:160px !important; color:#FFFFFF !important; text-shadow: 0 0 0 #fff;" type="submit" value="<?php _e( 'Reset Plugin Settings', 'extender' ); ?>" class="genesis-extender-reset button" name="Submit" onClick='return confirm("<?php _e( 'Are you sure your want to reset your Genesis Extender Settings?', 'extender' ); ?>")'/><input type="hidden" name="action" value="reset" />
				</form>
			</div>
		</div>
	</div> <!-- Close Wrap -->
