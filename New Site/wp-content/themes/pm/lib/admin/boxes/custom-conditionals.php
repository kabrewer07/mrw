...
<div id="dynamik-custom-options-nav-conditionals-box" class="dynamik-optionbox-outer-1col dynamik-all-options">
	<div class="dynamik-optionbox-inner-1col">
		...
		<span style="margin:-3px 10px 0 -75px !important; font-weight:normal; float:right;" class="button add-conditional"><?php _e( 'Add', 'dynamik' ); ?></span><span id="custom-conditionals-tooltip" class="tooltip-mark tooltip-bottom-center">[?]</span></h3>
