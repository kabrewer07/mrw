...
<div style="display:none;" id="dynamik-custom-php-builder" class="dynamik-optionbox-outer-1col">
	<div class="dynamik-optionbox-inner-1col">
		<h3 style="cursor:pointer; -moz-border-radius: 3px 3px 0px 0px; -webkit-border-radius: 3px 3px 0px 0px; border-radius: 3px 3px 0px 0px;"><?php _e( 'Custom PHP Builder', 'dynamik' ); ?> <span id="custom-php-builder-tooltip" class="tooltip-mark tooltip-bottom-center">[?]</span></h3>
